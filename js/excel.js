...
// ======================================
// Muat Library SheetJS (Lazy Load)
// Sengaja TIDAK dimuat otomatis di index.html supaya
// tidak memperlambat buka halaman. Baru diunduh saat
// Import/Export Excel benar-benar dipakai.
// ======================================

let _sheetJsPromise = null;

function muatLibraryExcel() {
    ...
    _sheetJsPromise = new Promise(function (resolve, reject) {
        ...
        script.onerror = function () {
            ...
            reject(new Error("Gagal memuat library Excel. Periksa koneksi internet Anda lalu coba lagi."));
        };
...
async function bacaExcel(file, opsi, callback) {
    try {
        await muatLibraryExcel();
    } catch (err) {
        gagal(err.message);
        return;
    }
...
async function tulisExcel(data, namaSheet, namaFile) {
    try {
        await muatLibraryExcel();
    } catch (err) {
        gagal(err.message);
...
async function exportBarangExcel() {
    ...
    await tulisExcel(data, "Data Barang", "Data_Barang.xlsx");
...
async function exportMasukExcel() {
    ...
    await tulisExcel(data, "Barang Masuk", "Barang_Masuk.xlsx");
...
// BARANG KELUAR
// ==========================================================
async function exportKeluarExcel() {
    ...
    await tulisExcel(data, "Barang Keluar", "Barang_Keluar.xlsx");
...
async function exportStockExcel() {
    ...
    await tulisExcel(data, "Stock Gudang", "Stock_Gudang.xlsx");
