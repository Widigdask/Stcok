...
function renderStock(data = getStockData()) {
    ...
    const totalNilaiStock = data.reduce(
        (total, item) => total + Number(item.totalNilai || 0),
        0
    );

    updateTotalNilaiStock(totalNilaiStock);

}

// ======================================
// Update Tampilan Total Nilai Stock
// (dipanggil setiap kali tabel Stock Gudang di-render,
// mengikuti data yang sedang tampil termasuk hasil pencarian)
// ======================================

function updateTotalNilaiStock(total) {

    const el = document.getElementById("totalNilaiStock");
